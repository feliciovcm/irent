...
import { UpdateUserAvatarController } from '../modules/accounts/useCases/UpadteUserAvatarUseCase/UpdateUserAvatarController';
...
usersRoutes.get('/', ensureAuthenticated, userProfileController.handle);
